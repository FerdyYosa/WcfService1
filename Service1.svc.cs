...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg;
            SqlConnection con = new SqlConnection("Data Source=desktop-gb128hp\\mssql2014; Initial Catalog=MyTestDB;Persist Security Info = True; User ID = sa; Password = FErdy277; Pooling = false;");
            con.Open();
